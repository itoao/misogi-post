...
interface AmplifyAuthContainer extends Components.AmplifyAuthContainer, HTMLElement {}
export const AmplifyAuthContainer: {
  prototype: AmplifyAuthContainer;
  new (): AmplifyAuthContainer;
};
