...
import { AuthState, ChallengeName, UsernameAlias, } from './types/auth-types';
...
export const handleSignIn = async (username, password, handleAuthStateChange, usernameAlias) => {
